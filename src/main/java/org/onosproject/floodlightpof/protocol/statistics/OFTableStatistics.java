...
public class OFTableStatistics implements OFStatistics {
    public static int maxTableNameLen = 32;
    ...
    public void readFrom(ChannelBuffer data) {
        ...
        data.readByte(); // pad
        data.readByte(); // pad
        this.name = StringByteSerializer.readFrom(data, maxTableNameLen);
    ...
    public void writeTo(ChannelBuffer data) {
        ...
        data.writeByte((byte) 0); // pad
        data.writeByte((byte) 0); // pad
        StringByteSerializer.writeTo(data, maxTableNameLen, this.name);
